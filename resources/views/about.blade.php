<x-guest-layout>
    ...
    <div class="mt-12 flex flex-col md:flex-row items-center text-center md:text-left">

        <div class="order-1 md:order-1 mb-6 md:mb-0 flex justify-center items-center">
            <!-- Image goes here -->
            <img src="https://justinreddportfolio1.files.wordpress.com/2023/10/jmredd_portrait.jpg?w=1024" alt="Your Image" class="w-1/2 rounded-full" />
        </div>
    ...
    <div class="mt-12 flex flex-col md:flex-row items-center">
        ...
        <div class="order-2 md:order-2 flex flex-col md:flex-row justify-center items-center">
            ...
            <div>
                <p class="mt-10 text-zinc-400 sm:text-left">I'm Justin Redd, a video game designer, artist, creative collaborator, writer and storyteller.
