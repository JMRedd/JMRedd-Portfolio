    ...
    <div class="container mx-auto mt-20">
        <div class="shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <form action="{{ route('portfolio.update', $game->id) }}" method="POST" enctype="multipart/form-data" id="portfolioForm">
                ...
                <div class="mb-4">
                    <label for="hide" class="block text-zinc-400 text-sm font-bold mb-2">Hide:</label>
                    <!-- Hidden input field -->
                    <input type="hidden" name="hide" value="0">
                    <!-- Checkbox -->
                    <input type="checkbox" name="hide" id="hide" class="bg-gray-600 text-zinc-300 p-2 border rounded" {{ $game->hide ? 'checked' : '' }} value="1">
                </div>
